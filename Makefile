...
#    Updated: 2022/08/27 18:37:59 by mbouthai         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_FS	:= push_swap.c stack.c stack_ops.c stack_utils.c stack_sort.c stack_mutate.c moves.c best_moves.c utils.c longest_increasing_subsequence.c
