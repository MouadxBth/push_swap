...
#    Updated: 2022/08/25 04:39:03 by mbouthai         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_FS	:= push_swap.c stack.c stack_ops.c stack_utils.c stack_sort.c stack_mutate.c quick_sort.c utils.c longest_increasing_subsequence.c
